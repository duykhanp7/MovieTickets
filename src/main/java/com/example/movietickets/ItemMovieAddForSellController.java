...
public class ItemMovieAddForSellController {
    ...
    @FXML
    public void onButtonAddToRoom(MouseEvent mouseEvent){
        onItemClickedListener.onButtonAddToRoom(movie);
